...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className="relative" style={{ background: '#111111' }}>
      {/* Top gradient border */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-violet-500 via-cyan-400 to-fuchsia-500" />
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-2">
            <a
              href="#"
              className="inline-block text-2xl font-bold bg-gradient-to-r from-violet-500 via-purple-500 to-fuchsia-500 bg-clip-text text-transparent mb-4"
            >
              NexusAI
            </a>
            <p className="text-gray-500 text-base leading-relaxed mb-6 max-w-sm">
              Transforming customer support with intelligent AI agents that
              understand, learn, and deliver exceptional experiences at scale.
            </p>
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-gray-500 hover:text-white transition-colors duration-300 p-2 rounded-lg hover:bg-white/5"
                >
                  {social.icon}
                </a>
              ))}
